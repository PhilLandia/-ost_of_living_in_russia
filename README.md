...
The project is distributed under the **[MIT License]((https://github.com/PhilLandia/Cost_of_living_in_Russia))**, allowing free use and modification of the code with attribution.
